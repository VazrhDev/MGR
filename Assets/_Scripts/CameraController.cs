...
namespace MGR
{
    public class CameraController : MonoBehaviour
    {
        ...
        public float rotationDamping = 3.0f;              // How Fast camera will catch up to car's Rotation
        public float heightDamping = 2.0f;              // How Fast camera will catch up to car's height
        public float zoomRatio = 0.5f;
        public float defaultFOV = 60f;
        private Vector3 rotationVector;

        [SerializeField] private bool IsFirstPersonCamera = false;

        [SerializeField] private Transform FPCameraLookObject;
        ...
        {
            carController = car.GetComponent<CarMovementController>();
            //FPCameraLookObject = carController.FPCameraLook.transform;
        }
        ...
        void LateUpdate()
        {
            if (car != null)
            {
                ...
                {
                    transform.LookAt(FPCameraLookObject);
                }
            }
        }
